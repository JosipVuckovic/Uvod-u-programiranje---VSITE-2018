Module pocetakIIzbor
    ...
    Sub Main()
        Console.WriteLine("******************************************************************")
        Console.WriteLine("*    UPROG VJEZBA 12                            Josip Vučković   *")
    ...
    Public Sub GlavniIzborniksub()
        Dim izbor As Object
        Console.WriteLine("**********************************************************************")
        Console.WriteLine("*    1 - Zadatak 1 - Brojanje člana stringa                          *")
        Console.WriteLine("*    2 - Zadatak 2 - Substring i lenght                              *")
        Console.WriteLine("*    3 - Zadatak 3 - Trim i Substring                                *")
        Console.WriteLine("*    4 - Zadatak 4 - ToUpper/Lower palindrom provjera                *")
        Console.WriteLine("*    5 - Zadatak 5 - Vrsta rečenice, broj samoglasnika, suglasnika   *")
