Module PocetakIIzbor
    ...
    Sub Main()
        Console.WriteLine("******************************************************************")
        Console.WriteLine("*    UPROG VJEZBA 8                             Josip Vučković   *")
    ...
    Public Sub GlavniIzborniksub()
        Dim izbor As Object
        Console.WriteLine("**********************************************************************")
        Console.WriteLine("*    1 - Zadatak 1 - Funkcije... Preracun celzija u kelvine          *")
        Console.WriteLine("*    2 - Zadatak 2 - Opcioni parametar... Unos mjesta rođenja        *")
        Console.WriteLine("*    3 - Zadatak 3 - Preopterecene procedure... ispis raznih stvari  *")
        Console.WriteLine("*    4 - Zadatak 4 - Funkcije... Okretanje znamenke broja            *")
        Console.WriteLine("*    5 - Zadatak 5 - Staticna varijabla... Brojanje unosa            *")
