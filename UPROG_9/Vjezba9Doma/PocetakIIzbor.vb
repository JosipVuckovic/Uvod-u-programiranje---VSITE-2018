Module PocetakIIzbor
    ...
    Sub Main()
        Console.WriteLine("******************************************************************")
        Console.WriteLine("*    UPROG VJEZBA 9                             Josip Vučković   *")
    ...
    Public Sub GlavniIzborniksub()
        Dim izbor As Object
        Console.WriteLine("**********************************************************************")
        Console.WriteLine("*    1 - Zadatak 1 - Direktan unos 5 stringova u array i ispis, bez P*")
        Console.WriteLine("*    2 - Zadatak 2 - Unos i ispis arraya pomocu petlje For Next      *")
        Console.WriteLine("*    3 - Zadatak 3 - Ne kuzim ovo...                                 *")
        Console.WriteLine("*    4 - Zadatak 4 - Unos temperature za cijeli tjedan               *")
